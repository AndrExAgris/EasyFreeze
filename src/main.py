...
class EasyfreezeApplication(Adw.Application):
    ...
    def __init__(self):
        super().__init__(application_id='com.app.easyfreeze',
    ...
    def on_about_action(self, widget, _):
        ...
        about = Adw.AboutWindow(transient_for=self.props.active_window,
                                ...
                                application_icon='com.app.easyfreeze',
                                developer_name='André de Campos, Jaasiel Abner Alves Sousa',
                                version='0.1.0',
                                developers=['André de Campos, Jaasiel Abner Alves Sousa'],
                                copyright='© 2024 André de Campos, Jaasiel Abner Alves Sousa')
        about.present()
